        ...
        <div class="container py-5">
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        ...
                        <button type="button" class="btn btn-primary mr-1">Follow</button>
            ...
            <div class="col-lg-8">
                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-9">
                        <p class="text-muted mb-0">{{users?.contact?.surname}} {{users?.contact?.name}} </p>
                    </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="col-sm-9">
                        <p class="text-muted mb-0">{{users?.contact?.email}}</p>
                    </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="col-sm-9">
                        <p class="text-muted mb-0">{{users?.contact?.phoneNumber}}</p>
                    </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="col-sm-9">
                        <p class="text-muted mb-0">{{ [users?.contact?.address , users?.contact?.city, users?.contact?.province?.name].join(', ') }}</p>
                    </div>
                    </div>
                </div>
                </div>
